...
<div class="ui container" id="app">
    <div class="ui pointing menu">
        <a class="active item">
            <img src="{{asset('vendor/laravel-form-builder/img/logomark.min.svg')}}" alt="">
            &nbsp;
            &nbsp;
            Laravel form builder
        </a>
        <a class="item" href="https://github.com/sadeghpm/laravel-form-builder" target="_blank">
...
<script src="{{asset('vendor/laravel-form-builder/app.js')}}"></script>
</body>
</html>
