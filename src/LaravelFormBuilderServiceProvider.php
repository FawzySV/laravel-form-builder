...
class LaravelFormBuilderServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'laravel-form-builder');
        ...
        if ($this->app->runningInConsole()) {
            ...
            // Publishing assets.
            $this->publishes([
                __DIR__.'/../public' => public_path('vendor/laravel-form-builder'),
            ], 'laravel-form-builder-assets');

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/laravel-form-builder'),
            ], 'lang');*/
    ...
    public function register()
    {
        ...
        $this->app->singleton('laravel-form-builder', function () {
